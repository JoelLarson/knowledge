...
See [[good-test-properties]] for full treatment.
...
[[dave-farley]] draws the analogy: a test and its implementation are two independent paths to the same answer. If both agree (test passes), confidence is high. Without this, the programmer is "only guessing, however good they are."
...
Teams that chase coverage as a metric often produce tests with no assertions ("liars"). See [[tdd-smells]].
...
Fucci et al. 2017 found that strict test-first sequencing was **not a significant predictor** of quality or productivity in their regression models. The granularity and uniformity of cycles mattered more. This challenges the dogma that the test must come literally before the code -- the discipline of small, consistent cycles may be the actual mechanism. See [[tdd-process-granularity]] for the full treatment and [[tdd-empirical-evidence]] for the broader research synthesis.
...
- [[tdd-empirical-evidence]] -- what the research actually says about TDD effectiveness
- [[tdd-process-granularity]] -- Fucci et al.'s finding that cycle granularity trumps sequencing
- [[bdd]]
- [[tdd-by-example-kent-beck]]
- [[clean-code-robert-martin]]
- [[dave-farley-302-course]]
- [[mutation-testing]] -- verifies that tests written first actually catch regressions by injecting faults

...
Cunningham's wiki invention reflects the same values that drive TDD: make knowledge explicit, keep it accessible, and evolve it continuously. His WikiWikiWeb became the platform where XP practitioners (including Beck) documented and refined TDD practices.

### Smalltalk Roots

The Beck-Cunningham collaboration in Smalltalk during the late 1980s and early 1990s laid the groundwork for both XP and TDD. The Chicago/Classical school of TDD traces its lineage directly to this Smalltalk community.

...
This wiki stores durable knowledge for Groundloop as interlinked markdown pages. It is meant to compound over time rather than be re-derived from scratch on every question.
...
- Use double-bracket wiki links for cross-references between wiki pages.
- Start each page with a short summary.
- Cite source summaries with relative markdown links when useful.

## Scope

This wiki is for product, domain, and research knowledge relevant to Groundloop.
...
- [Wiki Index](index.md)
- [Groundloop Wiki Overview](overview.md)
- [Wiki Log](log.md)
